export function fakeSqsMessage(message: any) {
  const body = {
    ...
    TopicArn: 'arn:aws:sns:us-east-1:000000000000:CreateServerlessAwsWebhookTopic',
    Message: JSON.stringify(message),
    Timestamp: '2024-08-12T20:43:00.303Z',
    UnsubscribeURL:
      'http://localhost.localstack.cloud:4566/?Action=Unsubscribe&SubscriptionArn=arn:aws:sns:us-east-1:000000000000:CreateServerlessAwsWebhookTopic:8ee10d1a-da7f-44f5-a488-e9e24d5e35e6',
    SignatureVersion: '1',
    Signature:
